...
class _AccueilState extends State<Accueil> {
  ...
  final List<Widget> _pages = [
    const AccueilContent(), // Votre page d'accueil
    const Essayer(),    // Page Essayer
    const FavorisPage(),    // Page Favoris
    const ProfilPage(),     // Page Profil
  ];
...
// Contenu de la page d'accueil (tout votre code original)
